...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _70437_archive_1.so
_70437_archive_1.so : archive.1/_70437_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_70437_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_70437_archive_1.so $@
...
CU_UDP_OBJS = \
objs/udps/ecrIU.o objs/udps/U7Vwg.o objs/udps/exIG1.o 
