...
HD_PWD='C:/Users/jacky/Desktop/ic_lab_2023/IC_LAB_2023/lab06/LAB06_SOFT_IP_PATTERN/LAB06_SOFT_IP_PATTERN.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SORT_IP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SORT_IP.tcl
