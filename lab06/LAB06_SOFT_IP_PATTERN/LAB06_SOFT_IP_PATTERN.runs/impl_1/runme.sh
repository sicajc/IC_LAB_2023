...
HD_PWD='C:/Users/jacky/Desktop/ic_lab_2023/IC_LAB_2023/lab06/LAB06_SOFT_IP_PATTERN/LAB06_SOFT_IP_PATTERN.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SORT_IP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SORT_IP.tcl -notrace
