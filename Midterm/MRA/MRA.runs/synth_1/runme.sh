...
HD_PWD='C:/Users/jacky/Desktop/ic_lab_2023/IC_LAB_2023/Midterm/MRA/MRA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MRA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MRA.tcl
